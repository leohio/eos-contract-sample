...
cleos push action toycashiopcs setpvdata '["toycashiopcs", "PCS", "https://www.geomerlin.com", 50]' -p toycashiopcs@active

cleos get table toycashiopcs toycashiopcs pvcount

cleos push action toycashiopcs removepvdata '["toycashiopcs", "PCS", "https://www.geomerlin.com"]' -p toycashiopcs@active
